...
fn main() {
    ...
    clock
        ...
        .unwrap();
    display_num(0u8, 6u8, &mut clock, true);
    thread::sleep(time::Duration::from_secs(2));
    display_num(0u8, 6u8, &mut clock, false);
}

fn display_num(location: u8, number: u8,display: &mut ht16k33::HT16K33<rppal::i2c::I2c>, on: bool) -> () {
    //   _   0
    //  |_|  5, 6, 1
    //  |_|  4, 3, 2
